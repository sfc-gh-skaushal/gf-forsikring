...
ALTER TABLE RAW_CLAIMS SET DATA_METRIC_SCHEDULE = 'TRIGGER_ON_CHANGES';

-- Define schedule on RAW_POLICIES (runs every 60 minutes)
--ALTER TABLE RAW_POLICIES SET DATA_METRIC_SCHEDULE = '5 MINUTE';
ALTER TABLE RAW_POLICIES SET DATA_METRIC_SCHEDULE = 'TRIGGER_ON_CHANGES';
...
ALTER ALERT ALERT_RAW_CLAIMS_NULL_CLAIM_ID SUSPEND;
...
ALTER ALERT ALERT_RAW_CLAIMS_DUPLICATE_CLAIM_ID SUSPEND;
...
ALTER ALERT ALERT_RAW_CLAIMS_INVALID_AMOUNT SUSPEND;
...
ALTER ALERT ALERT_RAW_CLAIMS_INVALID_DATES SUSPEND;
...
ALTER ALERT ALERT_RAW_CLAIMS_ORPHAN_CLAIMS SUSPEND;
...
ALTER ALERT ALERT_RAW_POLICIES_NULL_POLICY_ID SUSPEND;
...
ALTER ALERT ALERT_RAW_POLICIES_DUPLICATE_POLICY_ID SUSPEND;
...
ALTER ALERT ALERT_RAW_POLICIES_INVALID_COVERAGE SUSPEND;
